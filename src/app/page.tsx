  ...
  return (
    <>
        ...
        <div className="flex justify-center items-center rounded-lg border-[1px] my-2 border-solid border-[#E5E7EB] w-72 h-9 mx-auto">
            <button className="p-1 m-1 rounded-lg focus:bg-[#16181D] w-20 h-7 text-xs focus:text-white text-black flex justify-center items-center" autoFocus>
            ...
            <button className="p-1 m-1 rounded-lg focus:bg-[#16181D] w-20 h-7 text-xs focus:text-white text-black flex justify-center items-center">@ Handle</button>
            <button className="p-1 m-1 rounded-lg focus:bg-[#16181D] w-20 h-7 text-xs focus:text-white text-black flex justify-center items-center"># Hashtag</button>
        </div>
        <div className="mx-auto max-w-2xl m-4">
            ...
            <textarea name="tweet" className="border-2 m-2 p-2 border-solid border-[#E5E7EB] w-[39rem] h-24 block" placeholder="e.g. Yes, we know. Everyone likes coffee. You’re probably not even a “real writer” if you don’t have coffee siphoned down your throat as a form of alarm clock."/>
